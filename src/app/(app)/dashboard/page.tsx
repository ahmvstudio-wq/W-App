  ...
  return (
    <div className="space-y-4 pb-10 animate-fadeIn font-sans">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 pt-1">
        <div>
          <div className="text-[10px] font-mono text-neutral-400 uppercase tracking-widest font-normal mb-1">
            DASHBOARD
          </div>
          <h1 className="text-3xl sm:text-4xl font-medium tracking-[-0.025em] text-black flex items-center gap-3">
      ...
      {/* Hero Insight Card (Proper Monochrome Hardware Studio Layout) */}
            ...
            <div className="p-4 rounded-2xl bg-[#fafafa] border border-black/[0.06] transition-all">
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-mono text-neutral-500 font-medium uppercase tracking-wider">
